...
;; Append is an O(n) process because it traverses the entire list it
;; is appending. So its
;; slower. http://community.schemewiki.org/?sicp-ex-2.63
...
;; Selectors:
;; (a) If represent the numbers with rectangular coords:
...
;; (b) If represent the numbers with polar coords
...
;; Finally - the constructors:
(define (make-from-real-imag x y)
  (make-from-real-imag-rectangular x y))
(define (make-from-mag-ang r a)
  (make-from-mag-ang-polar r a))

;; And from Chap 3: We get the following:
